...
firstCalcNumber = parseFloat(window.prompt("Enter first number:"));
secondCalcNumber = parseFloat(window.prompt("Enter second number:"));
thirdCalcNumber = parseFloat(window.prompt("Enter third number:"));
